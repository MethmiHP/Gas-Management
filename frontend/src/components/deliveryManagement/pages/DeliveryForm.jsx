...
//           if (!value && value !== 0) return 'Amount is required for Cash On Delivery';
//           if (parseFloat(value) <= 0) return 'Amount must be greater than 0 for Cash On Delivery';
//         }
//         return '';
...
//       if (key !== 'driver') { // Driver is optional
...
//     // Update form data
//     if (name === 'paymentMethod' && value === 'Prepaid') {
//       setFormData({
//         ...formData,
//         [name]: value,
//         amountReceived: 0
...
//       // Navigate to deliveries page after 2 seconds
//       setTimeout(() => {
//         navigate('/deliveries');
//       }, 2000);
...
//             <p className="text-blue-100">Enter customer delivery details after payment</p>
//           </div>
...
//                       onChange={handleChange}
//                       onBlur={handleBlur}
//                       className={getInputClasses('amountReceived')}
//                       min="1"
//                       step="0.01"
